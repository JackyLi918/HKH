...
{
	public class SqlServerObjectBuilder : DataBaseObjectBuilder
	{
		#region Constructor

		public SqlServerObjectBuilder(HKHConnectionString configuration)
			: base(configuration)
		{
		}

		public SqlServerObjectBuilder(string connectionString)
