...
namespace HKH.Linq.Data.Common
{
    ...
    public abstract class QueryMapper
    {
        ...
        /// <param name="else"></param>
        /// <returns></returns>
        public abstract Expression GetPartialUpdateExpression(MappingEntity entity, Expression instance, LambdaExpression updateCheck, LambdaExpression selector, Expression @else);
