...
namespace HKH.Linq.Data.Common
{
    ...
    public class QueryBinder : DbExpressionVisitor
    {
        ...
        private Expression BindPartialUpdate(IEntityTable upd, Expression instance, LambdaExpression updateCheck, LambdaExpression resultSelector)
        {
            MappingEntity entity = this.mapper.Mapping.GetEntity(instance.Type, upd.TableId);
            return this.Visit(this.mapper.GetPartialUpdateExpression(entity, instance, updateCheck, resultSelector, null));
        }
