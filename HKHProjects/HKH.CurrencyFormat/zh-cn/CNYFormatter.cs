...
namespace HKH.CurrencyFormat
{
	...
	public class CNYUnitProvider : ICurrencyUnitProvider
	{
		...
		private void Init()
		{
            ...
            {
                { -2, new CurrencyUnit("分", -2) },
                { -1, new CurrencyUnit("角", -1) },
                { 0, new CurrencyUnit("元|圆", 0, true) },
                { 1, new CurrencyUnit("拾|十", 1) },
                { 2, new CurrencyUnit("佰|百", 2) },
                { 3, new CurrencyUnit("仟|千", 3) },
                { 4, new CurrencyUnit("万|萬", 4, true) },
                { 8, new CurrencyUnit("亿", 8, true) }
            };
        }
